...
export SERVICE_SETTINGS__SITEURL=${SERVICE_SETTINGS__SITEURL:="https://mattermost-chat.herokuapp.com/"}
...
export EMAIL_SETTINGS__SEND_EMAIL_NOTIFICATIONS=${EMAIL_SETTINGS__SEND_EMAIL_NOTIFICATIONS:=true}
export EMAIL_SETTINGS__REQUIRE_EMAIL_VERIFICATION=${EMAIL_SETTINGS__REQUIRE_EMAIL_VERIFICATION:=false}
export EMAIL_SETTINGS__FEEDBACK_NAME=${EMAIL_SETTINGS__FEEDBACK_NAME:="support@siriusfuture.ru"}
export EMAIL_SETTINGS__FEEDBACK_EMAIL=${EMAIL_SETTINGS__FEEDBACK_EMAIL:="support@siriusfuture.ru"}
export EMAIL_SETTINGS__FEEDBACK_ORGANIZATION=${EMAIL_SETTINGS__FEEDBACK_ORGANIZATION:=""}
export EMAIL_SETTINGS__SMTP_AUTH_ENABLED=${EMAIL_SETTINGS__SMTP_AUTH_ENABLED:=true}
export EMAIL_SETTINGS__SMTP_USERNAME=${EMAIL_SETTINGS__SMTP_USERNAME:="support@siriusfuture.ru"}
export EMAIL_SETTINGS__SMTP_PASSWORD=${EMAIL_SETTINGS__SMTP_PASSWORD:="mxesynzzhnocjigr"}
